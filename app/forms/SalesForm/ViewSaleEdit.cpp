                              ...
                              const QString& tooltip)
{
    ...
    if (!widget) {
        ...
        // gepflegte Zuordnung. Bis 27.08.2026 blieb der unbekannte Wert der Liste hinzugefuegt
        ...
        // seinen Teil heraus. Schlaegt das fehl, muss es sichtbar werden:
...
bool ViewSaleEdit::hasUnreadableFields(QStringList& fieldKeys) const
{
    fieldKeys.clear();
    ...
    const QList<QPair<QString, const QLineEdit*>> numericFields = {
        ...
        { QStringLiteral("salePrice"), m_salePrice },
